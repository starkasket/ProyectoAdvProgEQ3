...
public class Libro {
    ...
    */
    ...
    public Libro(String id, String nombre_del_libro_a_solicitar, String editorial, String Cliente_que_solicita, int cantidad_solicitada, String estado_Solicitud) {
        this.id = id;
    ...
    public Libro(String nombre_del_libro_a_solicitar, String editorial, String Cliente_que_solicita, int cantidad_solicitada, String estado_Solicitud) {
        this.nombre_del_libro_a_solicitar = nombre_del_libro_a_solicitar;
        this.editorial = editorial;
        this.Cliente_que_solicita = Cliente_que_solicita;
        this.cantidad_solicitada = cantidad_solicitada;
