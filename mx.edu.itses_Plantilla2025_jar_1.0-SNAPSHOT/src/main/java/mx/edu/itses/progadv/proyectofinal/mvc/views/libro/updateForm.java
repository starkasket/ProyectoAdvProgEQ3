...
public class updateForm extends javax.swing.JFrame {
     ...
     * @param editoriales
     */
    public updateForm(Libro model) {
        initComponents();
        this.setLocationRelativeTo(null);
        
        txtTitulo.setText(model.getTitulo());
        txtanio_publicacion.setText(String.valueOf(model.getAnio_publicacion()));
        txtnumero_paginas.setText(String.valueOf(model.getNumero_paginas()));
        
        int index = 0;
        for(String categoria:model.getCategorias()){
            cmbCategorias.addItem(categoria);
            if(categoria.equals(model.getCategoria())){
                cmbCategorias.setSelectedIndex(index);
            }
            index++;
        }
        ...
        for(String editorial:model.getEditoriales()){
            ...
            if(editorial.equals(model.getEditorial())){
                cmbEditoriales.setSelectedIndex(index);
            }
            index++;
        }
        ...
        btnGuardar.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                LibroView.mensaje("Se modificó el libro correctamente.");
