...
public class updateForm extends javax.swing.JFrame {
     ...
     * @param model
     */
    public updateForm(Empleado model) {
        initComponents();
        this.setLocationRelativeTo(null);
        txtNombre.setText(model.getNombre());
        txtApellidos.setText(model.getApellidos());
        
        System.out.println(model.getDepartamento());
        int indice = 0;
        for(String departamento:model.getDepartamentos()){
            cmbDepartamento.addItem(departamento);
            if(departamento.equals(model.getDepartamento())){
                cmbDepartamento.setSelectedIndex(indice);
            }
            indice++;
        }
        ...
        btnGuardar.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                EmpleadoView.guardarEmpleado(model.getId(),txtNombre.getText(), txtApellidos.getText(),                         
                        cmbDepartamento.getSelectedItem().toString());
                dispose();
                EmpleadoView.mensaje("Se modifico el empleado correctamente.");
            }
