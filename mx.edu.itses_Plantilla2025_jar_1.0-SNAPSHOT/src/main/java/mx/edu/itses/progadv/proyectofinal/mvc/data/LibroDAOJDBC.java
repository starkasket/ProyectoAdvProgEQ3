...
import static mx.edu.itses.progadv.proyectofinal.mvc.data.Conexion.close;
import static mx.edu.itses.progadv.proyectofinal.mvc.data.Conexion.getConnection;
...
public class LibroDAOJDBC implements LibroDAO {
  ...
  Connection conn = null;
         ...
         ResultSet rs = null;
         List<LibroPeticiones> libros= new ArrayList<>();
         try {
             conn = getConnection();
             ...
             while (rs.next()) {
                 ...
                 LibroPeticiones libro = new LibroPeticiones(id, nombre_del_libro_a_solicitar, cliente_que_solicita, cantidad_solicitada, estado_Solicitud);
                 libros.add(libro);
             }
  ...
  Connection conn = null;
    ...
    public Map<String, LibroPeticiones> editoriales() {
     Connection conn = null;
         PreparedStatement stmt = null;
         ResultSet rs = null;
         Map<String, LibroPeticiones> Mapa = new HashMap<>();
         try {
             conn = getConnection();
             ...
             while (rs.next()) {
                 ...
                 LibroPeticiones libro = new LibroPeticiones(editorial, estado_Solicitud);
